...
public class ESPP2AntiFraudWS {
     ...
     */
    public ESPP2AntiFraudWS(String urlESPP, String username, String password) {
        this.urlIC = urlESPP;
     ...
     */
    public ESPP2AntiFraudWS send(Template template) throws SOAPException {
        ...
        try (OutputStream connOutputStream = conn.getOutputStream()) {
