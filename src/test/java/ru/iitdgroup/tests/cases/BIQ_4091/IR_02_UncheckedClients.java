...
public class IR_02_UncheckedClients extends RSHBCaseTest {
    ...
    @Test(
            description = "Провести траназкцию \"Транзакция через госуслуги\" № 2 от имени Клиента № 2 - c полным совпадением ФИО с клиентом № 1",
    ...
    @Test(
            description = "Провести транзакцию \"Транзакция через госуслуги\" № 1 от имени Клиента № 1",
