...
public class GR_104_CC_LargerCommissionNOT_TRIGGERED extends RSHBCaseTest {


    private static final String RULE_NAME = "R01_GR_104_CC_LargerCommission";
    ...
    public void step0() {
        getIC().locateRules()
                ...
                .fillInputText("Подозрительное значение комиссии:","555")
                .save()
                .sleep(30);
        getIC().close();
    ...
    @Test(
            description = "Отправить транзакцию №1",
