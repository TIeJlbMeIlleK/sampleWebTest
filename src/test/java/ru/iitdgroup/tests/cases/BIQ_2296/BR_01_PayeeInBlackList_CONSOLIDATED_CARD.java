...
public class BR_01_PayeeInBlackList_CONSOLIDATED_CARD extends RSHBCaseTest {
    ...
    public void step1() {
        ...
        transactionData.getOuterTransfer().getPayeeProps().setPayeeAccount("12345810100000000004");
        transactionData.getOuterTransfer().getPayeeBankProps().setBIK("042301968");
        transactionData.getOuterTransfer().setOperationDescription("перевод на счет 12345810835620000480");
    ...
    public void step2() {
        ...
        transactionData
                .getOuterTransfer()
                .getPayeeProps()
                .setPayeeAccount("12345810100000000004");
        transactionData
                .getOuterTransfer()
                .getPayeeBankProps()
                .setBIK("042301968");
        transactionData
                .getOuterTransfer()
                .setOperationDescription("перевод на счет 12345810835620000505");
        sendAndAssert(transaction);
    ...
    public void step3() {
        ...
        transactionData
                .getOuterTransfer()
                .getPayeeProps()
                .setPayeeAccount("12345810100000000500");
        transactionData
                .getOuterTransfer()
                .getPayeeBankProps()
                .setBIK("042301968");
        transactionData
                .getOuterTransfer()
                .setOperationDescription("перевод на счет 12345810835620000480");
        sendAndAssert(transaction);
        assertLastTransactionRuleApply(NOT_TRIGGERED, NOT_EXIST_IN_BLACK_LIST);
    }
    @Test(
    ...
    public void step5() {
        ...
        transactionData
                .getOuterTransfer()
                .getPayeeProps()
                .setPayeeAccount("12345810835620000551");
        transactionData
                .getOuterTransfer()
                .getPayeeBankProps()
                .setBIK("042301654");
        transactionData
                .getOuterTransfer()
                .setOperationDescription("перевод на счет 12345810100000000987");
        sendAndAssert(transaction);
        assertLastTransactionRuleApply(NOT_TRIGGERED, NOT_EXIST_IN_BLACK_LIST);
    }
