...
public class BR_01_PayeeInBlackList_CONSOLIDATED_FIO extends RSHBCaseTest {
    ...
    public void editReferenceData(){
        ...
        getIC().locateTable(REFERENCE_ITEM_BLACK_CONSOLIDATED_FIO)
                .addRecord()
                .fillMasked("ФИО получателя:", "Иванов Иван Иванович")
    ...
    public void step1() {
        ...
        transactionData
                .getOuterTransfer()
                .setOperationDescription("на счет Иванов Иван Иванович");
        transactionData
                .getOuterTransfer()
                .getPayeeProps()
