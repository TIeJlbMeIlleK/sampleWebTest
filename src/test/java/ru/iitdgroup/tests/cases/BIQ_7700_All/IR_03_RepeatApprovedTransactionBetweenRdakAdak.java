...
public class IR_03_RepeatApprovedTransactionBetweenRdakAdak extends RSHBCaseTest {
    ...
    private final String destinationProduct = "40817810" + (ThreadLocalRandom.current().nextLong(0, Long.MAX_VALUE) + "").substring(0, 12);
    private final String ipAddress = "95.73.149.81";
    private final GregorianCalendar time = new GregorianCalendar();
    private final List<String> clientIds = new ArrayList<>();
    private final String nameAdakSuccess = "Ольга";
    private final String[][] names = {{"Петр", "Урин", "Семенович"}, {nameAdakSuccess, "Румянцева", "Григорьевна"}};
    ...
    public void transBetweenADAK() {
        ...
        String transaction_id = transactionDataBetween.getTransactionId();
        Long version = transactionDataBetween.getVersion();
        sendAndAssert(transBetween);
        assertLastTransactionRuleApply(NOT_TRIGGERED, "Нет подтвержденных транзакций для типа «Перевод между счетами», условия правила не выполнены");
