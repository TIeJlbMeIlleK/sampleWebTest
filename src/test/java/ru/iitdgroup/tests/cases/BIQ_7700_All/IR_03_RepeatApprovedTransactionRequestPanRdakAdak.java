...
public class IR_03_RepeatApprovedTransactionRequestPanRdakAdak extends RSHBCaseTest {
    ...
    @Test(
            description = "1. Провести транзакции для клиента №1, тип транзакции:" +
                    "Запрос реквизитов карты, проверить на отклонение суммы в пределах 25,5%," +
    ...
    @Test(
            description = "Отправить транзакцию №1 от клиента №1 спустя 5 мин от транзакции №1, " +
                    "тип транзакции Запрос реквизитов карты, сумма 500, остаток на счету 10000р, реквизиты совпадают с транзакцией №1." +
