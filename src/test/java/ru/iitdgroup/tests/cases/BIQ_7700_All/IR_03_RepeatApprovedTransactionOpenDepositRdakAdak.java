...
public class IR_03_RepeatApprovedTransactionOpenDepositRdakAdak extends RSHBCaseTest {
    ...
    @Test(
            description = "1. Провести транзакции для клиента №1, тип транзакции:" +
                    "Открытие вклада, проверить на RDAK, отклонение суммы," +
    ...
    @Test(
            description = "Отправить транзакцию №1 от клиента №1 спустя 5 мин от транзакции №1, " +
                    "тип транзакции Открытие вклада, сумма 500, остаток на счету 10000р, реквизиты совпадают с транзакцией №1." +
