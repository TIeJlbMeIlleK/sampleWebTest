...
public class R01_W6_WhiteRule_VES_regular extends RSHBCaseTest {
    ...
    public void enableRules() {
        System.out.println("R01_W6_Whiterule_VES.\n" +
                "Проверка на обработку регулярных транзакций -- BIQ2370 " + "ТК №31");
    ...
    @Test(
            description = "Отправить транзакцию 1, любую по Клиенту 1, регулярная",
