...
public class TestOfCriticalTransaction extends RSHBCaseTest {
...
//    FIXME Требуется доработать автотест после исправления тикета https://yt.iitdgroup.ru/issue/BIQ2370-109
    ...
    public void enableRuleForAlert() {
        System.out.println("\"Критичность транзакции\" -- BIQ2370" + " ТК№27");
        getIC().locateRules()
                .selectVisible()
                .deactivate()
                .sleep(3);
    ...
    public void refactorParametres() {
        ...
        getIC().locateTable(TABLE)
                ...
                .fillInputText("Критичность транзакции:","Normal")
