...
public class NonTypicalGeoPositionJobBoxFalse extends RSHBCaseTest {
    ...
    private final String[][] names = {{"Ольга", "Михалкова", "Игоревна"}, {"Степан", "Зубков", "Семенович"}};
    ...
    public void enableRules() {
        ...
        getIC().locateTable(REFERENCE_ITEM)
                .deleteAll()
                .addRecord()
                .fillCheckBox("Требуется сбор нетипичной геопозиции:", false)
    ...
    public void addClients() {
        ...
        getIC().locateTable(REFERENCE_ITEM_TUPICAL_LOCATION)
                ...
                .save();
        getIC().locateTable(REFERENCE_ITEM_QUARANTINE_LOCATION)
                .addRecord()
