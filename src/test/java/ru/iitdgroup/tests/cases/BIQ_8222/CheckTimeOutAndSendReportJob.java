...
public class CheckTimeOutAndSendReportJob extends RSHBCaseTest {
    ...
    @Test(
            description = "1. Транзакция №1 (Перевод на карту (Номер карты получателя -- 4578956321458796))," +
                    "сумма 1000. Увеличить по транзакции REQUEST_TIMESTAMP для  типа SAF_RESPONSE на 9000.",
    ...
    @Test(
            description = "1. Транзакция №2 (Перевод между счетами), сумма 1000." +
                    "Увеличить по транзакции REQUEST_TIMESTAMP для  типа SAF_RESPONSE на 9000.",
    ...
    @Test(
            description = "2. Для транзакции №3 увеличить REQUEST_TIMESTAMP для  типа SAF_RESPONSE на 7000",
