...
//    private String[][] names = {{"Петр", "Урин", "Семенович"}, {"Сергей", "Румянцев", "Григорьевич"},
//            {"Семен", "Кудрявцев", "Семенович"}, {"Дмитрий", "Кругляков", "Андреевич"}};
//
...
//TODO не сделана интеграция с ОСС